...

{
	...
	for (int i = 0; i < 2; i++) {
	CD3DX12_RESOURCE_BARRIER v1 = CD3DX12_RESOURCE_BARRIER::Transition(texBuff[i].Get(), D3D12_RESOURCE_STATE_PIXEL_SHADER_RESOURCE, D3D12_RESOURCE_STATE_RENDER_TARGET);
...
{
	for (int i = 0; i < 2; i++) {
		CD3DX12_RESOURCE_BARRIER v1 = CD3DX12_RESOURCE_BARRIER::Transition(texBuff[i].Get(),
