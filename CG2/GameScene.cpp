...
//	loadBossPopData(1);
	...
	for (int i = 0; i < jsonLoader->GetObjectData(); i++)
	{
		...
		/*a = lerp(jsonLoader->GetPoint1(i), jsonLoader->GetPoint2(i), t);
		b = lerp(jsonLoader->GetPoint2(i), jsonLoader->GetPoint3(i), t);*/
